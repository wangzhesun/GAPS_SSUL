...
def get_argparser():
    ...
    parser.add_argument("--dataset", type=str, default='voc', choices=['voc', 'ade', 'coco'], help='Name of dataset')
...
def get_dataset(opts, seed):
    ...
    dataset_dict = {}
    dataset_dict['train'] = dataset(opts=opts, image_set='train', transform=train_transform, cil_step=opts.curr_step, seed=seed)
